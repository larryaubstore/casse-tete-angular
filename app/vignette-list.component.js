...
var VignetteListComponent = (function () {
    function VignetteListComponent() {
        console.info('Vignette List Component Mounted Successfully');
    }
    VignetteListComponent = __decorate([
        core_1.Component({
    ...
    return VignetteListComponent;
}());
exports.VignetteListComponent = VignetteListComponent;
